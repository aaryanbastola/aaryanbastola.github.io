...
# os.path.expanduser("~") automatically finds the current user's home directory (e.g., C:\Users\LENOVO)
SOURCE_TO_TARGET = {
    ...
    os.path.join(os.path.expanduser("~"), "Downloads", "cert.pdf"): "certificate4.pdf",  # Intro to Cybersecurity
}
